    ...
    <div>
        <form method="post">
            ...
            <div class="button-group-area mt-10">
                ...
                <button type="submit" class="genric-btn primary-border circle" name="ctof" value="submitted">C to F
                </button>
                <button type="submit" class="genric-btn primary-border circle" name="ftoc" value="submitted">F to C
                </button>
